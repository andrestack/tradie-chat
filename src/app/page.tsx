    ...
    <main className="flex flex-col w-full min-h-screen bg-gray-50 relative">
      ...
      <div className="flex-1 px-4 pb-8">
        <div className="w-full max-w-2xl mx-auto space-y-6">
            ...
            <div className="flex items-start gap-2">
              ...
              {transcription && (
                <button
                  ...
                  className="opacity-100 group-hover:opacity-100 p-2 hover:bg-gray-100 rounded-md transition-all flex-shrink-0"
          ...
          {/* Chat Response Card */}
          <div className="bg-white rounded-xl shadow-sm p-6 relative group min-h-[300px] mb-20">
            <h2 className="text-sm font-medium text-gray-500 mb-3">
              AI Response
            </h2>
            <div className="flex items-start gap-2">
              ...
              {chatResponse && (
                <button
                  ...
                  className="opacity-100 p-2 hover:bg-gray-100 rounded-md transition-all flex-shrink-0 sticky top-0"
                  title="Copy to clipboard"
                >
                  {copied ? (
                    <Check className="w-5 h-5 text-green-500" />
